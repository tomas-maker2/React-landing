...
const Navbar = () => {
  ...
  return (
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
        <div className='px-2 flex justify-between items-center w-full h-full'>
            <div className='flex items-center'>
                <h1 className='text-3xl font-bold mr-4 sm:text-4xl'>BRANDS</h1>
                <ul className='hidden md:flex'>
                    ...
                    <li>
                    <Link to="plataform" smooth={true} offset={-100} duration={500}>Plataforms</Link>
                    </li>
                    <li>
        ...
        <div className='md:hidden mr-4' onClick={handleClick}>
            {!nav ? <AiOutlineMenuFold className='w-10'/> 
    ...
    <li className='border-b-2 border-zinc-300 w-full'>
    <Link onClick={handleClose} to="plataform" smooth={true} offset={-100} duration={500}>Plataforms</Link>
    </li>
    <li className='border-b-2 border-zinc-300 w-full'>
